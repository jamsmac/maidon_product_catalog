...
export default {
  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        'elevation-sm': '0 2px 8px rgba(30, 58, 95, 0.08)',
        'elevation-md': '0 4px 16px rgba(30, 58, 95, 0.10)',
        'elevation-lg': '0 8px 24px rgba(30, 58, 95, 0.12)',
        'elevation-xl': '0 12px 32px rgba(30, 58, 95, 0.15)',
      },
      animation: {
